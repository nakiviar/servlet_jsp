...
public class MySQLConexion {
	...
	public static Connection getConexion() {
		...
		try {
			...
			String url = "jdbc:mysql://localhost:3306/bd_clientes?useTimezone=True&serverTimezone=UTC";
			// variable String que contiene los datos del servidor
			String usr = "root";// variable String que contiene el dato del usuario
			String psw = "sasa";// variable String que contiene el dato del password
